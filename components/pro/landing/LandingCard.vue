...
.background-gradient::before {
  background: radial-gradient(250px circle at var(--x) var(--y), v-bind(colorLight) 0%, transparent 100%);
...
.dark {
  .background-gradient::before {
    background: radial-gradient(250px circle at var(--x) var(--y), v-bind(colorDark) 0%, transparent 100%);
  }
